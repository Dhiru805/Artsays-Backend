...
const packageMaterialArtist = new mongoose.Schema({
...
const PackageMaterialArtistSchema = mongoose.model("PackageMaterialArtistSchema", packageMaterialArtist);
module.exports = PackageMaterialArtistSchema;